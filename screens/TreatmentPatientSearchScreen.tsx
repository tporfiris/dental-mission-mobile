// screens/TreatmentPatientSearchScreen.tsx - ENHANCED VERSION WITH SCROLLING AND BETTER TEXT VISIBILITY
...
const TreatmentPatientSearchScreen = ({ navigation }: any) => {
  ...
  const renderPatientItem = ({ item }: { item: Patient }) => (
    <View style={styles.patientCard}>
      ...
      <TouchableOpacity
        style={styles.treatmentButton}
        onPress={() => handleBeginTreatment(item)}
      >
        <Text style={styles.treatmentButtonText}>Begin Treatment</Text>
      </TouchableOpacity>
    </View>
...
export default TreatmentPatientSearchScreen;
